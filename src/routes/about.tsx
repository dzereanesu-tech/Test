    ...
    <SiteShell>
      ...
      <section className="border-y border-white/10 bg-slate-900/40">
        <div className="mx-auto w-full max-w-7xl px-6 py-16">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-jade-300">Timeline</p>
          <h3 className="mt-2 text-3xl font-black">Milestones in our journey</h3>
...
function TimelineCard({ text, title, year }: { text: string; title: string; year: string }) {
  return (
